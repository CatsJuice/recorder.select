...
export const recorders: Recorder[] = ([
  ...
  {
    // Verified against https://github.com/KartikLabhshetwar/better-shot/releases/tag/v0.5.2
    id: 'bettershot',
    name: 'BetterShot',
    website: 'https://www.bettershot.site/',
    lastUpdatedAt: '2026-09-11',
    lastUpdatedVersion: '0.5.2 (19)',
    technologyApproach: 'Native',
    platforms: ['mac'],
    supportsIntelMac: true,
    appSizeMB: 37.6, // arm64 DMG: 37,587,733 bytes (decimal MB).
    requiresRegistration: false,
