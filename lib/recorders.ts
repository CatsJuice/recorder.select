...
export const fieldGroups: FieldGroup[] = [
  ...
  { key: 'cameraRecording', label: 'Camera recording', parentKey: 'recording', defaultExpanded: false, getCollapsedPreview: capabilityPreview(['supportsCameraBeauty', 'supportsCameraAvatar', 'supportsCameraBackgroundRemoval', 'supportsCameraBackgroundReplacement']) },
...
export const fieldDefinitions: FieldDefinition[] = [
  ...
  { key: 'appSizeMB', label: 'Application size', type: 'number', group: 'general', placeholder: '100', description: 'Disk space occupied by the installed application in MB, not the installer or download size.', unit: 'MB' },
  ...
  { key: 'supportsCameraAvatar', label: 'Virtual avatar', type: 'boolean', group: 'cameraRecording' },
  ...
  { key: 'supportsCameraLayouts', label: 'Additional camera layouts', type: 'boolean', group: 'cameraLayouts', description: 'Supports camera layouts beyond basic picture-in-picture, such as side-by-side or top-and-bottom layouts.' },
  ...
  { key: 'supportsPresetImportExportSharing', label: 'Import / export / share', type: 'boolean', group: 'presets', description: 'Can export presets as local files visible in Finder and import preset files.' },
];
...
export const recorders: Recorder[] = ([
  ...
  {
    // Updated for v0.5.3 with maintainer-reviewed video capabilities; keep known unsupported fields false.
    id: 'bettershot',
    name: 'BetterShot',
    website: 'https://www.bettershot.site/',
    lastUpdatedAt: '2026-09-13',
    lastUpdatedVersion: '0.5.3(20)',
    technologyApproach: 'Native',
    platforms: ['mac'],
    supportsIntelMac: true,
    appSizeMB: 51.2, // Installed application size reported by the maintainer.
    requiresRegistration: false,
    availableOnMacAppStore: false,
    isOpenSource: true,
    supportsCli: true, // Terminal invocation via open "bettershot://capture/region".
    supportsMcp: false,
    supportsBuiltInAgent: false,
    monthlyPrice: 0,
    quarterlyPrice: 0,
    ...
    supportsCustomModelAnimations: false,
    supportsMosaic: true,
    // Screenshot-only annotations do not count as video annotation support.
    supportsTextAnnotations: false,
    supportsArrowAnnotations: false,
    supportsLineAnnotations: false,
    supportsBoxAnnotations: false,
  ...
  },
  {
    ...
    lastUpdatedVersion: '2.5.0 20260901',
    technologyApproach: 'Native',
    platforms: ['mac', 'win'],
    supportsIntelMac: null,
    appSizeMB: 294.6,
    ...
    supportsClickEffects: true,
    supportsTranscription: true,
    transcriptionProviders: ['local-whisper-kit', 'official-api'],
    supportsSubtitleEditing: true,
    supportsWordLevelEditing: false,
    subtitleOutputType: 'burned-in',
    supportsBackgroundMusic: true,
  ...
  },
  {
    id: 'snapzy',
    name: 'Snapzy',
    website: 'https://snapzy.app',
    lastUpdatedAt: '2026-09-08',
    lastUpdatedVersion: '1.31.0 (173)',
    technologyApproach: 'Native',
    platforms: ['mac'],
    supportsIntelMac: true,
    appSizeMB: 73,
  ...
  },
  {
    id: 'screenix',
    name: 'Screenix',
    website: 'https://screenix.studio',
    lastUpdatedAt: '2026-09-15',
    lastUpdatedVersion: '1.7.5',
    technologyApproach: 'Tauri',
    platforms: ['linux'],
    supportsIntelMac: false,
    appSizeMB: 75,
